                                ...
                                <div class="col-12 col-md-6">
                                    <div class="input-block local-forms">
                                        ...
                                        <select name="cancer_type" class="form-control select2">
                                            ...
                                            <option value="glioblastoma" {{ old('cancer_type', $lastMonitoring ? $lastMonitoring->cancer_type : '')=='glioblastoma' ? 'selected' : '' }}>Glioblastoma</option>
                                            <option value="meningioma" {{ old('cancer_type', $lastMonitoring ? $lastMonitoring->cancer_type : '')=='meningioma' ? 'selected' : '' }}>Meningioma</option>
                                            <option value="neuroblastoma" {{ old('cancer_type', $lastMonitoring ? $lastMonitoring->cancer_type : '')=='neuroblastoma' ? 'selected' : '' }}>Neuroblastoma</option>
                                            <option value="other" {{ old('cancer_type', $lastMonitoring ? $lastMonitoring->cancer_type : '')=='other' ? 'selected' : '' }}>Other</option>
                                        </select>
                                    </div>
                                </div>
